...
<head>
    ...
    <title>Instalación YSJ</title>
    <link rel="shortcut icon" href="./app/views/assets/images/laravel.png">
    <meta content="Laravel API" name="description" />
    <meta content="Laravel API" name="author" />
    <!-- Materializecss compiled and minified CSS -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.98.0/css/materialize.min.css">
    <!--Import Google Icon Font-->
    <link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <!--Import Materialize-Stepper CSS -->
    <link rel="stylesheet" href="app/core/assets/install/css/materialize-stepper.min.css">
    <link href="app/core/assets/install/css/style.css" rel="stylesheet" type="text/css">
</head>
...
<body>
    <div class="container">
        <div class="row">
            <div class="col s12">
                <img src="./app/views/assets/images/laravel.png" alt="Laravel" class="logo">
                <div class="card">
                            ...
                            <ul class="stepper linear horizontal" id="wizard-install">
                                    ...
                                    <div class="step-content">
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input name="site[name]" type="text" class="validate" required>
                                                <label>Nombre del proyecto</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input name="site[path]" type="text" class="validate" value="<?= (($path) == '') ? '/' : "/{$path}" ?>" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input name="view[path]" type="text" class="validate" value="app/views" required>
                                                <label>Carpeta de vistas</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input name="view[layout]" type="text" class="validate" value="templates/main" required>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col s12">
                                                <p>Ambiente (Desarrollo/Producción)</p>
                                                <div class="switch">
                                                    <label>
                                                        DEV
                                                        <input type="checkbox" name="debug[environment]">
                                                        <span class="lever"></span>
                                                        PRO
                                                    </label>
                                                </div>
                                ...
                                <li class="step">
                                    ...
                                    <div class="step-content">
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input name="mail[from]" type="text" class="validate" value="Laravel <correo@dominio.com>" required>
    ...
    <script src="app/core/assets/install/js/materialize-stepper.min.js"></script>
    <script type="text/javascript" src="app/core/assets/install/js/actions.js"></script>
</body>
